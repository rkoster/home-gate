...
var $author$project$Main$Status = F3(
...
var $author$project$Main$deviceDecoder = A5(
	...
	A2($elm$json$Json$Decode$field, 'daily_active_minutes', $elm$json$Json$Decode$int),
	A2(
...
var $author$project$Main$statusDecoder = A4(
	...
	$author$project$Main$Status,
	A2($elm$json$Json$Decode$field, 'DevicesChecked', $elm$json$Json$Decode$int),
	A2($elm$json$Json$Decode$field, 'UsersFetched', $elm$json$Json$Decode$int),
	A2(
		$elm$json$Json$Decode$field,
		'devices',
		$elm$json$Json$Decode$list($author$project$Main$deviceDecoder)));
var $author$project$Main$url = 'http://localhost:8080/status';
var $author$project$Main$fetchStatus = $elm$http$Http$get(
	{
